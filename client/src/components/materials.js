...
export default class Materials extends React.Component {
        constructor(props) {
            ...
            this.showFullSection = this.showFullSection.bind(this);
        }
    ...
    render() {
     return (
            <div className="materials" id="materials">
                ...
                <div className={this.state.visible ? 'material-section': 'material-section hide'} >
                    ...
                    <div className="material-block">
                        ...
                        <div className="material-block-body">
                            <div className="material-block-material">
                                ...
                                <div className="material-block-description"> Полимер предназначен для точной печати детализированных моделей, литьевых форм и может использоваться на производстве. Смола имеет высокую скорость затвердевания, что обеспечивает прочность готовых изделий и значительно сокращает время печати.</div>
                                <div className="material-block-item">35 руб/см3</div>
                            </div>
                            <div className="material-block-material">
                                <div className="material-block-item">Выжигаемый</div>
                                <div className="material-block-description">Работа с литьевым фотополимером отличается от работы с воском, это два разных процесса: фотополимер выжигается, а не вытапливается. Поэтому муфельная печь должна быть с принудительной вентиляцией.</div>
                    ...
                    <div className="materials-show-more-btn" onClick={this.showFullSection}>смотреть больше</div>
            </div>
        )
    }
