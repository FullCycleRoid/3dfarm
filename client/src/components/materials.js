            ...
            <div className="material-block">
                ...
                <div className="material-block-body">
                    <div className="material-block-material">
                        ...
                        <div className="material-block-item">Безусловный лидер рынка материалов для FDM печати – экологичный, биосовместимый, термопластичный состав. Его применяют для изготовления игрушек, посуды, сувенирной продукции, элементов корпусов для бытовой техники, дизайнерских моделей, мастер моделей.</div>
                        <div className="material-block-item">10 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">PETG</div>
                        <div className="material-block-item">PETG может стать идеальным решением для 3Д печати, так как этот материал сумел соединить в себе все положительные характеристики ABS и PLA</div>
                        <div className="material-block-item">10 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">HIPS</div>
                        <div className="material-block-item">Получающиеся детали и объекты, которые созданы с использованием только этого филамента, прочны и в меру пластичны и, кроме всего прочего, довольно легкие. HIPS более мягкий и гладкий материал, его легче обрабатывать механическим способом, в отличии от PLA или ABS. </div>
                        <div className="material-block-item">10 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">ABS</div>
                        <div className="material-block-item">ABS пластик 1,75 SolidFilament черный 1 кг используется для печати трехмерных моделей, для которых характерны высокая прочность, устойчивость к температурным перепадам, солям, щелочам и кислотам. С помощью филамента производят печать приборов, деталей роботов, медицинских приборов, образовательных моделей, рекламных объектов и т.д. Также пластик применяется для построения архитектурных моделей.</div>
                        <div className="material-block-item">10 руб/см3</div>
                    </div>
                </div>
            </div>
            ...
            <div className="material-block">
                ...
                <div className="material-block-body">
                    <div className="material-block-material">
                        ...
                        <div className="material-block-item">инженерный пластик для 3D-печати. Материал зарекомендовал себя как обладатель низкой усадки, высокой прочности и жесткости напечатанных изделий, не требующей трудоемкой постобработки. </div>
                        <div className="material-block-item">20 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">Nylon</div>
                        <div className="material-block-item">Материал, обладающий высокой устойчивостью к повышенным температурам, не содержит вредных примесей, не искажается при нагревании, пластичный и легко обрабатывается после отливки. Несмотря на большую усадку, превосходит ABS по своим прочностным характеристикам. Обладает самосмазывающими свойствами, что позволяет использовать его в качестве подшипников. Отличительная особенность - низкая воспламеняемость.</div>
                        <div className="material-block-item">30 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">SBS</div>
                        <div className="material-block-item">Новый вид материала оставил в себе все лучшие достоинства и был дополнен еще несколькими новыми свойствами: стойкость к высоким температурам и морозам, твердый и ударопрочный, Повышенная разрывная прочность, стойкость к абразивным материалам. Этот материал больше подходит для создания конструкций, чем декораций, он во многом превосходит ABS-пластики.</div>
                        <div className="material-block-item">35 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">ABSPlus-430</div>
                        <div className="material-block-item">Благодаря совокупности физико-технических характеристик и низкой стоимости, ABSplus-P430 широко применяется в концептуальном моделировании и создании функциональных прототипов, а так же для изготовления конечных деталей для использования.</div>
                        <div className="material-block-item">35 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">PС поликарбонат</div>
                        <div className="material-block-item">отличающийся хорошей ударопрочностью, выдерживающий различные температуры и предназначенный для изготовления различных кухонных изделий, медицинского производства, а также конструкций для приборов</div>
                        <div className="material-block-item">25 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">ABS/PС</div>
                        <div className="material-block-item">Совмещает в себе свойства ABS и поликарбоната (за счет их непосредственного смешивания). ABS обеспечивает технологичность, а поликарбонат - ударопрочность, термостойкость и механические свойства.</div>
                        <div className="material-block-item">25 руб/см3</div>
                    </div>
                </div>
            </div>
            ...
            <div className="material-block">
                ...
                <div className="material-block-body">
                    <div className="material-block-material">
                        ...
                        <div className="material-block-item"> Полимер предназначен для печати литьевых форм и может использоваться на производстве. Смола имеет высокую скорость затвердевания, что обеспечивает прочность готовых изделий и значительно сокращает время печати.</div>
                        <div className="material-block-item">35 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">Выжигаемый</div>
                        <div className="material-block-item">Работа с литьевым фотополимером Anycubic отличается от работы с воском, это два разных процесса: фотополимер выжигается, а не вытапливается. Поэтому муфельная печь должна быть с принудительной вентиляцией.</div>
            ...
            <div className="material-block">
                ...
                <div className="material-block-body">
                    <div className="material-block-material">
                        ...
                        <div className="material-block-item">Cостоит на 40% из дерева. Термобработке поддается пластик подобно PLA. Готовое изделие напоминает фактуру дерева на ощупь и имеет запах дерева. Возможна постобработка изделий.</div>
                        <div className="material-block-item">30 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">laybrick имитатор керамики</div>
                        <div className="material-block-item">Материал для 3D печати, позволяющий в зависимости от температуры получать различное качество поверхности: от очень гладких до шероховатых, по ощущениям и виду похожим на песчаник.</div>
                        <div className="material-block-item">40 руб/см3</div>
                    </div>
                    <div className="material-block-material">
                        <div className="material-block-item">bronzefill имитатор бронзы</div>
                        <div className="material-block-item">Материал с добавлением мелкого бронзового порошка. Данные нити в 3 раза тяжелее обычного PLA, а его плотность составляет 3,9 г/см.куб. По тактильным свойствам материал напоминает настоящую бронзу.</div>
                        <div className="material-block-item">40 руб/см3</div>
                    </div>
                </div>
            </div>
